...
const obRequest = () => {
  ...
  const filteredRequests = obRequests.filter((req) => {
    ...
    const matchesSearch =
      req.employee_firstname.toLowerCase().includes(searchTerm.toLowerCase()) ||
      req.employee_lastname.toLowerCase().includes(searchTerm.toLowerCase()) ||
          ...
          <dialog id="details-modal" className="modal modal-open">
            <div className="modal-box">
              ...
              <div className="mt-4 space-y-2">
                ...
                <p>
                  <strong>Name:</strong> {selectedRequest.employee_firstname}{" "}
                  {selectedRequest.employee_lastname}
                </p>
                <p>
                ...
                <p>
                  ...
                  {selectedRequest.overtime_hours} hrs
                </p>
